...
<petclinic:layout pageName="vets">
    ...
    <form:form modelAttribute="vet" class="form-horizontal" id="add-vet-form">
        <div class="form-group has-feedback">
            ...
            <petclinic:selectField label="Especialidades" name="specialties" names="${specialties}" size="3"/>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <c:choose>
                    <c:when test="${vet['new']}">
                        <button class="btn btn-default" type="submit">Anadir veterinario</button>
                    </c:when>
                    <c:otherwise>
