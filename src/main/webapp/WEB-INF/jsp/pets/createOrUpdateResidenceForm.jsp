...
<petclinic:layout pageName="owners">
   ...
   <jsp:body>
        <h2><c:if test="${residence['new']}">Nuevo </c:if>alojamiento</h2>
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td><petclinic:localDate date="${residence.pet.birthDate}" pattern="yyyy/MM/dd"/></td>
                <td><c:out value="${residence.pet.type.name}"/></td>
                <td><c:out value="${residence.pet.owner.firstName} ${residence.pet.owner.lastName}"/></td>
            </tr>
        </table>

        <form:form modelAttribute="residence" class="form-horizontal">
            <div class="form-group has-feedback">
                <petclinic:inputField label="Fecha registro" name="registerDate"/>
                <petclinic:inputField label="Fecha salida" name="releaseDate"/>
            </div>

            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <input type="hidden" name="petId" value="${residence.pet.id}"/>
        ...
        <table class="table table-striped">
            ...
            <c:forEach var="residence" items="${residence.pet.residences}">
